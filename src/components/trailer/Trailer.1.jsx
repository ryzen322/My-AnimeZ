    ...
    <div className=" flex flex-col rounded-md overflow-hidden font-Roboto p-1 gap-2 xl:flex-row">
      <div className="">
        {player ? (
          ...
          <div className=" aspect-video relative bg-stone-500 rounded-md flex flex-col justify-center gap-1 md:bg-slate-500 md:justify-end md:py-2 lg:bg-stone-800 xl:h-[30rem] 2xl:h-[43rem]">
            <picture>
              <img
